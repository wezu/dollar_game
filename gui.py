...
class UI(DirectObject):
    ...
    '''
    def __init__(self, font_name, big_font_name, mono_font_name,
                       font_size=18, big_font_size=94, mono_font_size=16):
        #txt props
        ...
        self.font = loader.load_font(font_name)
        ...
        self.big_font=loader.load_font(big_font_name)
        ...
        self.mono_font= loader.load_font(mono_font_name)
        ...
        self.click_sound=loader.load_sfx('gui/click.ogg')
    ...
    def text(self, txt, pos, parent, align='center',  color=(1.0, 1.0, 1.0, 1.0), big_font=True, mono_font=False, wordwrap=None, name=None, sort=0):
    ...
    def button(self, txt, cmd, width, pos, parent, txt_fg=(1.0, 1.0, 1.0, 1.0), align='center', mono_font=False,  style='', hidden=False, sort_dict={}, name=None):
        '''Creates a button
        '''
        if parent in self.elements:
            parent = self.elements[parent]
